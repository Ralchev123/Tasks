...
import catHouse.repositories.RepositoryImpl;
...
public class EngineImpl implements Engine {
    ...
    public EngineImpl() {
        Repository toyRepository = new RepositoryImpl(); // Create toy repository instance
        this.controller = new ControllerImpl(toyRepository); // Pass toy repository to ControllerImpl constructor
